                    ...
                    <div className="row align-items-center">
                        <div className="col-5">
                            <div className="footer-top-data d-flex gap-30 align-items-center">
                                ...
                                <h2 className='mb-0 text-white'>Nhận thông báo khuyến mãi</h2>
                            </div>
                        </div>
                        <div className="col-7">
                            <div className="input-group">
                                <input type="text" className="form-control py-1" placeholder="Nhập email của bạn..." aria-label="Recipient's username" aria-describedby="basic-addon2" />
                    ...
                    <div className="row">
                        <div className="col-4">
                            ...
                            <div className="text-white fs-6">
                                <address>Địa chỉ: 95 Thúy Lĩnh, Lĩnh Nam, Hoàng Mai, Hà Nội</address>
                                <a className='mt-3 d-block mb-0 text-white' href="tel:+84348232305">SĐT: 0348232305</a>
                                <a className='mt-3 d-block mb-0 text-white' href="mailto:laivanson.devc@gmail.com">Email: laivanson.dev@gmail.com</a>
                        ...
                        <div className="col-3">
                            ...
                            <div className="footer-link d-flex flex-column">
                                <Link className='text-white py-2 mb-1'>Thông tin</Link>
                ...
                <div className="container-xxl">
                    <div className="row">
                        <div className="col-12">
                            <p className='text-center mb-0 text-white'>&copy; {new Date().getFullYear()} Powered by Atomic</p>
                        </div>
                    </div>
                </div>
            </footer>
